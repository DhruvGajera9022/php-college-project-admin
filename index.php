    ...
    <main>
        ...
        ?>
            ...
            <div class="image image-class">
                <a href="productPage.php?id=<?php echo $row['slug']; ?>">
                ...
                <a class="btn btn-primary swalDefaultSuccess" href="dashboard.php?pid=<?php echo $row['id']; ?>&addToCart=1" id="btnAddToCart" style="margin: 10px;">Add to cart</a>
            </div>
        <?php
        }
        ?>
